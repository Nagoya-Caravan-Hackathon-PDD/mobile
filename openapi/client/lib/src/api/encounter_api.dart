...
class EncounterApi {
  ...
  const EncounterApi(this._dio, this._serializers);
  ...
  Future<Response<OutputListEncounterResponse>> encountersEncounterIdGet({
    ...
    OutputListEncounterResponse? _responseData;
    ...
    return Response<OutputListEncounterResponse>(
      data: _responseData,
  ...
  Future<Response<BuiltList<OutputListEncounterResponse>>> encountersGet({
    ...
    BuiltList<OutputListEncounterResponse>? _responseData;
    ...
    return Response<BuiltList<OutputListEncounterResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<OutputCreateEncounterResponse>> encountersPost({
    ...
    OutputCreateEncounterResponse? _responseData;
    ...
    return Response<OutputCreateEncounterResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
